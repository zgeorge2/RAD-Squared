...
import com.vmware.akka.common.SystemProperties;
import com.vmware.apps.adm.ctrl.AdmAppInitializer;
import com.vmware.apps.bank.ctrl.BankingAppInitializer;
import com.vmware.apps.nfv.ctrl.NFVAppInitializer;
import com.vmware.apps.nfv.ctrl.ThirdPartyInitializer;
...
public class SBExternalComponents {
    private static final String pkgPref = "com.vmware";
    ...
    @Bean
    ControllerDependency createLemansOnPremVapDelegate(RegistryManager rm) {
        return new LemansOnPremVapDelegate(rm);
    }
